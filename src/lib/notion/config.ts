...
export const NOTION_DB_PROJECTS_ID = process.env.NOTION_DB_PROJECTS_ID || '';
export const NOTION_DB_PROJECT_CATEGORY_ID = process.env.NOTION_DB_PROJECT_CATEGORY_ID || '';
